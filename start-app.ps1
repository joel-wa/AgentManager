...
try {
    ...
    Write-Host "[1/3] Starting Main Agent Service (port 8001)..." -ForegroundColor Green
    ...
    Write-Host "[2/3] Starting Embeddings Service (port 8002)..." -ForegroundColor Green
    ...
    Write-Host "[3/3] Starting Rust Core (Frontend + API on port 8000)..." -ForegroundColor Green
    ...
    Write-Host "  Embeddings:     http://localhost:8002/health" -ForegroundColor Gray
    Write-Host ""
