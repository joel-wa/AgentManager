...
async fn main() -> anyhow::Result<()> {
    ...
    let api_router = Router::new()
        ...
        .route("/projects/:id/files/*path/versions", get(api::list_file_versions))
        .route("/projects/:id/files/*path/versions/:version", get(api::get_file_version))
        .route("/projects/:id/files/*path/versions/:version/restore", post(api::restore_file_version))
